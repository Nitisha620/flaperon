...
Future<Set<Marker>> buildStartEndMarkers({
  required LatLng start,
  required LatLng end,
}) async {
  final startIcon = await getMarkerIcon(Colors.black,
      isIcon: true,
      icon: Icons.motorcycle_outlined,
      iconColor: Colors.yellowAccent,
      isStart: true);

  final image = await loadUiImage('assets/destination.png');
  final endIcon = await getMarkerIcon(
    Colors.red,
    isIcon: true,
